        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500">
              ...
              <li>
                <Link href="https://model.baai.ac.cn" target="_blank" className="hover:text-blue-600 transition-colors">
                  开放模型
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500">
              ...
              <li>
                <Link href="/license" className="hover:text-blue-600 transition-colors">
                  开源协议
                </Link>
              </li>
            </ul>
